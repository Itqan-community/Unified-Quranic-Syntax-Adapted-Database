# TR-AB-MULTILINGUAL_TRANSLATIONS Database Status
*QuranEnc Translation Collection - QCS Compliant*

## Current Database Files

### Main Database (RECOMMENDED)
- **`TR-AB-MULTILINGUAL_TRANSLATIONS.db`** - 104KB
...
1. **Use `TR-AB-MULTILINGUAL_TRANSLATIONS.db`** as your primary database
...
## Database Structure (TR-AB-MULTILINGUAL_TRANSLATIONS.db)
